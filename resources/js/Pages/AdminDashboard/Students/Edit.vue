<template>
    <!-- Modal content -->
    <Modal :modalHeadingText="'Edit Student'" :modalHeadingResetButton="true" :modalWidth="2">
        <template #body>
            ...
            <FormCheckBox :label="'Agree to Terms and Conditions'" :name="'tac'" :checked="true" v-model="studentInfo.tac"
                :error="errors.tac">
            </FormCheckBox>
        </template>
        <template #footer>
