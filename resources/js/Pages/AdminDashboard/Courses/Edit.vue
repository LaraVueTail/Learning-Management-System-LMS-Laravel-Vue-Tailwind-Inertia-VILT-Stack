<template>
    ...
    ></DeleteAlert>
    <!-- Modal content -->
    <div class="grid md:grid-cols-2 gap-6 md:w-3/4">
        <Modal
            :modalHeadingText="'Edit Course'"
        ...
        >
                ...
                <div class="grid md:grid-cols-2 gap-6">
                    ...
                    <div>
                        <FormFileUploadSingle
                            @fileChange="
                                (file) => (courseInfo.thumbnail = file[0])
                            "
                            :label="'Course Thumbnail'"
                            :oldImageLink="course.thumbnail_url"
                            :name="'thumbnail'"
                            :hideInputBox="true"
            ...
            <template #footer>
                ...
                ></Button>
                <Button
                    @click.prevent="deleteId = course.id"
                    :text="'Delete Course'"
                    :color="'red'"
                ></Button>
            </template>
