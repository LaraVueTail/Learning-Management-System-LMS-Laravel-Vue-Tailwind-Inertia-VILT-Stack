<template>
    <div class="bg-zinc-600 min-h-48 z-50">
        <div class="md:max-w-6xl py-10 mx-auto flex justify-between px-2">
            <div>
            ...
            <div>
                <div
                    class="text-gray-100 font-poppins text-sm hover:underline cursor-pointer hover:text-white space-x-3 grid justify-items-end md:justify-items-start md:grid-cols-3"
                >
                    <a href="">Projects</a>
                    <a href="">About</a>
                    <a href=""
